...
const demoChunks: Omit<DataChunk, 'id'>[] = [
  // Profile
  {
    ...
    type: 'profile',
    metadata: { type: 'profile', source: 'github', url: 'https://github.com/unclevikram' },
  },
  ...
  // Language summary
  {
    ...
    metadata: { type: 'language_summary', source: 'github' },
  },
  ...
  // Contribution summary
  {
    ...
    metadata: { type: 'contribution_summary', source: 'github' },
  },
  ...
  // Repos
  {
    ...
    type: 'repo_overview',
    metadata: { type: 'repo_overview', source: 'github', repo: 'api-gateway', language: 'Go', url: 'https://github.com/unclevikram/api-gateway' },
  },
  {
    ...
    type: 'repo_overview',
    metadata: { type: 'repo_overview', source: 'github', repo: 'fastapi-boilerplate', language: 'Python', url: 'https://github.com/unclevikram/fastapi-boilerplate' },
  },
  {
    ...
    type: 'repo_overview',
    metadata: { type: 'repo_overview', source: 'github', repo: 'event-stream', language: 'TypeScript', url: 'https://github.com/unclevikram/event-stream' },
  },
  {
    ...
    type: 'repo_overview',
    metadata: { type: 'repo_overview', source: 'github', repo: 'k8s-deploy-scripts', language: 'Shell', url: 'https://github.com/unclevikram/k8s-deploy-scripts' },
  },
  {
    ...
    type: 'repo_overview',
    metadata: { type: 'repo_overview', source: 'github', repo: 'digital-twin', language: 'TypeScript', url: 'https://github.com/unclevikram/digital-twin' },
  },
  ...
  // READMEs
  {
    ...
    type: 'readme',
    metadata: { type: 'readme', source: 'github', repo: 'api-gateway', section: 'Features' },
  },
  {
    ...
    type: 'readme',
    metadata: { type: 'readme', source: 'github', repo: 'api-gateway', section: 'Architecture' },
  },
  {
    ...
    type: 'readme',
    metadata: { type: 'readme', source: 'github', repo: 'fastapi-boilerplate', section: 'Tech Stack' },
  },
  {
    ...
    type: 'readme',
    metadata: { type: 'readme', source: 'github', repo: 'event-stream', section: 'Key Concepts' },
  },
  ...
  // Commits
  {
    ...
    type: 'commit',
    metadata: { type: 'commit', source: 'github', repo: 'api-gateway', date: '2024-10-15T00:00:00Z' },
  },
  {
    ...
    type: 'commit',
    metadata: { type: 'commit', source: 'github', repo: 'fastapi-boilerplate', date: '2024-09-30T00:00:00Z' },
  },
  {
    ...
    type: 'commit',
    metadata: { type: 'commit', source: 'github', repo: 'event-stream', date: '2024-08-28T00:00:00Z' },
  },
  ...
  // Pull Requests
  {
    ...
    type: 'pull_request',
    metadata: { type: 'pull_request', source: 'github', repo: 'api-gateway', date: '2024-10-14T00:00:00Z', labels: ['enhancement', 'reliability'], url: 'https://github.com/unclevikram/api-gateway/pull/23' },
  },
  {
    ...
    type: 'pull_request',
    metadata: { type: 'pull_request', source: 'github', repo: 'fastapi-boilerplate', date: '2024-09-08T00:00:00Z', labels: ['feature'], url: 'https://github.com/unclevikram/fastapi-boilerplate/pull/14' },
  },
  {
    ...
    type: 'pull_request',
    metadata: { type: 'pull_request', source: 'github', repo: 'event-stream', date: '2024-08-11T00:00:00Z', labels: ['feature', 'reliability'], url: 'https://github.com/unclevikram/event-stream/pull/8' },
  },
  ...
  // Issues
  {
    ...
    type: 'issue',
    metadata: { type: 'issue', source: 'github', repo: 'api-gateway', date: '2024-09-01T00:00:00Z', labels: ['bug', 'performance'], url: 'https://github.com/unclevikram/api-gateway/issues/19' },
  },
  {
    ...
    type: 'issue',
    metadata: { type: 'issue', source: 'github', repo: 'fastapi-boilerplate', date: '2024-09-23T00:00:00Z', labels: ['bug'], url: 'https://github.com/unclevikram/fastapi-boilerplate/issues/11' },
  },
]
